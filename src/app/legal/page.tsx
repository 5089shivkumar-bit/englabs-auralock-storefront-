...
export default function LegalPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-purple-500/30 overflow-x-hidden font-sans pb-24">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[500] px-6 py-6 md:px-12 flex justify-between items-center bg-black/40 backdrop-blur-2xl border-b border-white/5">
        ...
        <button 
          ...
          className="px-8 py-3 bg-gradient-to-r from-purple-600 to-cyan-500 rounded-full text-[11px] font-black uppercase tracking-widest text-white shadow-[0_0_30px_rgba(147,51,234,0.4)] hover:shadow-[0_0_50px_rgba(147,51,234,0.7)] transition-all duration-300 border border-white/20"
        >
          SALES
        </button>
      </nav>
      ...
      <main className="pt-40">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase font-mono mb-6 leading-tight">
          ...
          >
            ...
            {/* Product Disclaimer */}
            <motion.section variants={itemVariants} className="bg-[#0a0a0a] border border-purple-600/30 rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-black uppercase tracking-tighter font-mono">Product Disclaimer</h2>
              </div>
            ...
            {/* Privacy Policy */}
            <motion.section variants={itemVariants} className="bg-[#0a0a0a] border border-white/5 rounded-[2.5rem] p-10 md:p-14">
              <div className="flex items-center gap-4 mb-10">
                <FileText className="text-purple-500 w-8 h-8" />
                <h2 className="text-3xl font-black uppercase tracking-tighter font-mono">Privacy Policy</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                  ...
                  <div>
                    <h4 className="text-white font-black uppercase tracking-widest text-sm mb-3">Data Usage</h4>
                ...
                <div className="bg-white/5 rounded-[2rem] p-8 border border-white/5">
                  <h4 className="text-purple-500 font-black uppercase tracking-widest text-sm mb-4 flex items-center gap-2">
            ...
            <motion.section variants={itemVariants} className="bg-[#0a0a0a] border border-white/5 rounded-[2.5rem] p-10 md:p-14">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-black uppercase tracking-tighter font-mono">Terms & Conditions</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  <div key={i} className="flex gap-6">
                    ...
                    <div>
                      <h5 className="text-white text-xs font-black uppercase tracking-widest mb-2">{term.title}</h5>
            ...
            <motion.section variants={itemVariants} className="bg-[#0a0a0a] border border-white/5 rounded-[3rem] p-10 md:p-14 relative overflow-hidden">
               <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-600 to-cyan-500" />
               
               <h2 className="text-3xl font-black uppercase tracking-tighter font-mono mb-12">Corporate Information</h2>
               
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                  <div>
                    <h3 className="text-xl font-black uppercase tracking-widest text-white mb-4 font-mono">ENGLABS INDIA PRIVATE LIMITED</h3>
                    <div className="space-y-6">
                      <div className="flex gap-4 items-start">
                        <Building2 className="w-5 h-5 text-purple-500 shrink-0 mt-1" />
                        <div>
                          <p className="text-gray-400 text-sm font-bold leading-relaxed uppercase tracking-widest">
                      ...
                      <Link href="https://www.englabs.co" className="inline-flex items-center gap-2 text-purple-500 text-sm font-black uppercase tracking-[0.2em] hover:gap-4 transition-all group">
                  ...
                  <div className="space-y-8">
                    <div className="flex gap-6 items-center">
                      ...
                      <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-purple-500 mb-1">Sales & Orders</h4>
                        <p className="text-white text-sm font-bold underline font-mono">barrydeveloperindia@gmail.com</p>
                      </div>
                    </div>
                    <div className="flex gap-6 items-center">
                      <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-gray-400">
                      ...
                      <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-purple-500 mb-1">Sales WhatsApp</h4>
                        <p className="text-white text-sm font-bold font-mono">+91 9878407934</p>
                      </div>
                    </div>
                  </div>
               </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-black uppercase tracking-widest text-gray-500 font-mono">Legal Repository</span>
            </div>
            
            <div className="flex gap-12 items-center flex-wrap justify-center">
              <Link href="/support" className="text-[10px] font-black text-gray-500 uppercase tracking-widest hover:text-white transition">Support Center</Link>
              <Link href="/#products" className="text-[10px] font-black text-gray-500 uppercase tracking-widest hover:text-white transition">Inventory</Link>
